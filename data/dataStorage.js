export const dataStore = [
  {
    ...
    name: "Juno",
    desc: "Danish rybread with alot of different toppings",
    address: "Ymervej 21",
    city: "Copenhagen",
    phone: "54354334",
    tags: ["vegan"],
  ...
  },
  {
    ...
    desc: "Delicious italian food with pizza and shaghetti",
    city: "Copenhagen",
    phone: "86787667",
    tags: ["italian"],
    rating: 4.7,
...
export const restaurantArrayTwo = [
  {
    id: 1,
    image:
      "https://images.unsplash.com/photo-1562565651-7d4948f339eb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1489&q=80",
    name: "Green Mango",
    desc: "Thai food - Pad thai and much more",
    address: "Ymervej 21",
    city: "Copenhagen",
    rating: 3.4,
    tags: ["thai food"],
